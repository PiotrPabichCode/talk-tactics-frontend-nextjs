...
export function Footer() {
  return (
    ...
    //   </Link>
    // </footer>
    <footer className='px-4 py-6 mt-auto shadow-sm border-t md:flex md:items-center md:justify-center gap-6'>
      ...
      <div className='flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse'>
        <Link
          href='https://github.com/PiotrPabichCode/talk-tactics-frontend-nextjs'
        ...
        <Link
          href='https://github.com/PiotrPabichCode/talk-tactics-backend-springboot'
          className='text-gray-400 hover:text-gray-900 dark:hover:text-white'>
          <svg
            className='w-4 h-4'
            aria-hidden='true'
